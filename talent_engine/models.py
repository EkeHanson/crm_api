...
#     compliance_checklist = models.JSONField(default=lambda: [], blank=True, validators=[validate_compliance_checklist])
...
#             new_item = {
#                 'id': str(uuid4()),  # Ensure ID is a string UUID
#                 'name': name,
...
#         """Remove a compliance item from the checklist."""
